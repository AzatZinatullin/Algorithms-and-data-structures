...
void put_point(int a, int b)
{
    if (on_screen(a,b))
        screen[a][b] = black;
    else throw out_of_screen("Выход точки за экран");
}
...
void rectangle::draw()
{
    ...
    { cout << "в прямоугольнике " << e.what() << endl; }
}
...
void triangle::draw()
{
    ...
    { cout << "в треугольнике " << e.what() << endl; }
}
